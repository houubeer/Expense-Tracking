...
abstract class ICategoryBudgetManager {
  Future<void> updateCategoryBudget(int categoryId, double budget, int currentVersion);
  Future<void> updateCategorySpent(int categoryId, double spent, int currentVersion);
}
