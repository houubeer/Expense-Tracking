      ...
      try {
        ...
        if (dbFile.existsSync()) {
          ...
          try {
            ...
            final backupPath = '${dbFile.path}.corrupt.${DateTime.now().millisecondsSinceEpoch}';
        ...
        if (attempt == maxRetries - 1) {
          throw Exception('Failed to connect to database after $maxRetries attempts: $e');
        }
        print('Database connection attempt ${attempt + 1} failed: $e. Retrying...');
