/// Application route names and navigation constants
class AppRoutes {
  // Auth routes
  ...
  static const String pendingApproval = '/auth/pending';
  ...
  static const String employeeManagement = '/manager/employees';
